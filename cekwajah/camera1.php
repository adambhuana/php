...
<body>
	...
	<script language="JavaScript">
		webcam.set_api_url( 'record1.php' );
	...
	<br/><form>
		...
		&nbsp;&nbsp;
		<input type=button value="Take Snapshot" onClick="take_snapshot()" id="takephoto">
	</form>
		...
		function my_completion_handler(msg) {
			...
			if (msg.match(/(http\:\/\/\S+)/)) {
				...
				document.getElementById('upload_results').innerHTML = 
					...
					'<p>This Page will close in <span id="countdowntimer">5</span> Seconds</p>';
				// reset camera for another shot
				  //setInterval(refreshAndClose, 5000);
				  var timeleft = 5;
					var downloadTimer = setInterval(function(){
					timeleft--;
					document.getElementById("countdowntimer").textContent = timeleft;
